...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: jfLcf6w3hglQ6i/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__hxjza)}
              role={"img"}
            />
          ),
