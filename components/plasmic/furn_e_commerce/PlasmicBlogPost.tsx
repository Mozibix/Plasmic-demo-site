...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: VfuWBhBfxNus-a/css
  ...
  return (
    ...
    >
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__f7QTx, {
            [sty.freeBoxlong__f7QTxRjia]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__l0XTh)}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kDsV, {
          [sty.freeBoxlong__kDsVRjia]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
