...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: _QXz08NNmqgwAr/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: Kqw7TDSdcFjpd7/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: pNqqLRPGPG6kCc/icon
    ...
    >
      ...
      >
        {(hasVariant($state, "expanded", "expanded") ? true : true) ? (
          <BarsIcon
            className={classNames(projectcss.all, sty.svg__sFcG4, {
              [sty.svgexpanded__sFcG4Ndknc]: hasVariant(
                $state,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant($state, "expanded", "expanded") ? true : true) ? (
          <TimesIcon
            className={classNames(projectcss.all, sty.svg__szhsq, {
              [sty.svgexpanded__szhsqNdknc]: hasVariant(
                $state,
                "expanded",
                "expanded"
              )
